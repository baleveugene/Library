...
<html>
    ...
    <body>                  
        <div id="main">               
            <div id="content"> 
                <div id="form_name"><h1>Delete Book</h1></div>
                ...
                <form:form class="formBox" id="form-add" action="/book-${book.url}/delete" method="post">
                    <h2>Are you really want to delete this book?</h2>                      
